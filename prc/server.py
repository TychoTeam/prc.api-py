...
class Server:
    ...
    async def get_players(self):
        ...
        players = [
            ...
            for p in self._handle(await self._requests.get("/players"), List[ServerPlayerResponse])
        ]
    ...
    async def get_bans(self):
        ...
        return [
            ...
            for p in (self._handle(await self._requests.get("/bans"), ServerBanResponse)).items()
        ]
    ...
    async def get_vehicles(self):
        ...
        return [
            Vehicle(self, data=v)
            for v in self._handle(await self._requests.get("/vehicles"), List[ServerVehicleResponse])
        ]
...
class ServerLogs(ServerModule):
    ...
    async def get_access(self):
        ...
        [
            ...
            for e in self._handle(await self._requests.get("/joinlogs"), List[ServerJoinLogResponse])
        ]
    ...
    async def get_kills(self):
        ...
        return [
            ...
            for e in self._handle(await self._requests.get("/killlogs"), List[ServerKillLogResponse])
        ]
    ...
    async def get_commands(self):
        ...
        return [
            ...
            for e in self._handle(await self._requests.get("/commandlogs"), List[ServerCommandLogResponse])
        ]
    ...
    async def get_mod_calls(self):
        ...
        return [
            ...
            for e in self._handle(await self._requests.get("/modcalls"), List[ServerModCallResponse])
        ]
