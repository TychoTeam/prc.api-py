...
- 💫 **Full Coverage**  
  Supports ALL features from both API v1 and v2 as of _July 2026_.
- 🛡️ **Maintained**  
...
- **Utilities**  
  Useful utilities and helper methods spread across the package to make your life easier.
- **Prevents Bans**  
...
- **By Humans**  
  Made and maintained by humans. You can even [talk to us](https://discord.tycho.team)!
